 ...
 */
int64_t PartitionController::get_partition_container_count(
		int32_t partitionIndex) {
	int64_t value;
	GSResult ret = gsGetPartitionContainerCount(mController, partitionIndex,
			&value);
 ...
 */
void PartitionController::get_partition_container_names(int32_t partitionIndex,
